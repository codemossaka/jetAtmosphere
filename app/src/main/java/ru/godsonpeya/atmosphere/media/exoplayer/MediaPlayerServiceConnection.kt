...
import ru.godsonpeya.atmosphere.media.constants.K
import ru.godsonpeya.atmosphere.media.service.MediaPlayerService
...
class MediaPlayerServiceConnection @Inject constructor(
    ...
    val currentPlayingAudio = mutableStateOf<SongWithVerses?>(null)
    ...
    private var audioList = listOf<SongWithVerses>()
    ...
    fun playAudio(audios:List<SongWithVerses>){
        audioList = audios
    ...
    private inner class MediaControllerCallBack : MediaControllerCompat.Callback() {
        ...
        override fun onMetadataChanged(metadata: MediaMetadataCompat?) {
            ...
            currentPlayingAudio.value = metadata?.let { data ->
                audioList.find {
                    it.song.id.toString() == data.description.mediaId
                }
            }
        }
